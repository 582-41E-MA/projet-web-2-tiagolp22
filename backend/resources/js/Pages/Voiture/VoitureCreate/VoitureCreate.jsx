        ...
        <>
            ...
            <div className="form-container">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        <label htmlFor="date_arrivee">{t("car.arrival_date")}</label>
                        <input
                            className="date"
                            type="date"
                            name="date_arrivee"
                    ...
                    <div className="form-group">
                        <label htmlFor="prix_achat">{t("car.purchase_price")}</label>
                        <input
                            type="text"
                            name="prix_achat"
                            id="prix_achat"
                    ...
                    <div className="form-group">
                        <label htmlFor="prix_vente">{t("car.sale_price")}</label>
                        <input
                            type="text"
                            name="prix_vente"
                            id="prix_vente"
                    ...
                    <div className="form-group">
                        <label htmlFor="type_transmission_id">{t("car.transmission_type")}</label>
                        <select
                            className="form-select"
                        ...
                        {errors.type_transmission_id && (
                            <span className="error">{errors.type_transmission_id}</span>
                        )}
                    </div>

                    <div className="form-group">
                        <label htmlFor="groupe_motopropulseur_id">{t("car.powertrain_group")}</label>
                        <select
                            className="form-select"
                        ...
                        >
                            <option className="form-option" value="">{t("car.select_option")}</option>
                        ...
                        {errors.groupe_motopropulseur_id && (
                            <span className="error">{errors.groupe_motopropulseur_id}</span>
                        )}
                    </div>

                    <div className="form-group">
                        <label htmlFor="type_carburant_id">{t("car.fuel_type")}</label>
                        <select
                            className="form-select"
                        ...
                        {errors.type_carburant_id && (
                            <span className="error">{errors.type_carburant_id}</span>
                        )}
                    </div>

                    <div className="form-group">
                        <label htmlFor="carrosserie_id">{t("car.body_type")}</label>
                        <select
                            className="form-select"
                            name="carrosserie_id"
                            id="carrosserie_id"
                        ...
                        {errors.carrosserie_id && (
                            <span className="error">{errors.carrosserie_id}</span>
                        )}
                    </div>

                    <div className="form-group">
                        <label htmlFor="nombre_portes">{t("car.number_of_doors")}</label>
                        <input
                            type="text"
                            name="nombre_portes"
                            id="nombre_portes"
                        ...
                        {errors.nombre_portes && (
                            <span className="error">{errors.nombre_portes}</span>
                        )}
                    </div>

                    <div className="form-group">
                        <label htmlFor="nombre_places">{t("car.number_of_seats")}</label>
                        <input
                            type="text"
                            name="nombre_places"
                            id="nombre_places"
                        ...
                        {errors.nombre_places && (
                            <span className="error">{errors.nombre_places}</span>
                        )}
                    </div>
                    ...
                    <div className="form-group">
                        <label htmlFor="etat_vehicule">{t("car.vehicle_state")}</label>
                        <input
                            type="text"
                            name="etat_vehicule"
                            id="etat_vehicule"
                        ...
                        {errors.etat_vehicule && (
                            <span className="error">{errors.etat_vehicule}</span>
                        )}
                    </div>

                    <div className="form-group">
                        <label htmlFor="commandes_id_commande">{t("car.order_id")}</label>
                        <input
                            type="text"
                        ...
                        {errors.commandes_id_commande && (
                            <span className="error">{errors.commandes_id_commande}</span>
                        )}
                    </div>
